...
class AddBookComponent extends Component {
  constructor(props) {
    ...
    this.changepublishedyearHandler = this.changepublishedyearHandler.bind(this);
  ...
  saveBook = (e) => {
    if (e && e.preventDefault) { // add?
      ...
      let book = {id: this.state.id, bookname: this.state.bookname, bookauthor: this.state.bookauthor, publisher: this.state.publisher, publishedyear: this.state.publishedyear};
        ...
        <div className="container">
          <div className="row" style={{marginTop: "35px"}}>
            <div className="card col-md-6 offset-md-3 offset-md-1" >
              <h2 className="text-center" style={{marginTop: "10px"}}>Add a Book</h2>
              ...
              <div className="card-body">
                <form>
                  ...
                  <button className="btn btn-success" onClick={this.saveBook}>Save Book Details</button>
